...
- [ ] **Security-sensitive flow** — touches secrets, local files, external URLs, generated artifacts, desktop privileges, dependencies, release behavior, telemetry/diagnostics, or model-provider configuration
